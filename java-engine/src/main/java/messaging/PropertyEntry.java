...
public final class PropertyEntry extends Table {
  ...
  public static PropertyEntry getRootAsPropertyEntry(ByteBuffer _bb) {
    return getRootAsPropertyEntry(_bb, new PropertyEntry());
  }
  ...
  public static int createPropertyEntry(FlatBufferBuilder builder, int keyOffset, int valueOffset) {
  ...
  public static void startPropertyEntry(FlatBufferBuilder builder) {
    builder.startTable(2);
  }
  ...
  public static PropertyEntry __lookup_by_key(
      PropertyEntry obj, int vectorLocation, String key, ByteBuffer bb) {
  ...
  public static final class Vector extends BaseVector {
    ...
    public PropertyEntry get(int j) {
      return get(new PropertyEntry(), j);
    }

    public PropertyEntry get(PropertyEntry obj, int j) {
      return obj.__assign(__indirect(__element(j), bb), bb);
    }

    public PropertyEntry getByKey(String key) {
      return __lookup_by_key(null, __vector(), key, bb);
    }

    public PropertyEntry getByKey(PropertyEntry obj, String key) {
