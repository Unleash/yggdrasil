...
public final class ContextMessage extends Table {
  ...
  public String runtimeHostname() { int o = __offset(18); return o != 0 ? __string(o + bb_pos) : null; }
  public ByteBuffer runtimeHostnameAsByteBuffer() { return __vector_as_bytebuffer(18, 1); }
  public ByteBuffer runtimeHostnameInByteBuffer(ByteBuffer _bb) { return __vector_in_bytebuffer(_bb, 18, 1); }
  public messaging.PropertyEntry properties(int j) { return properties(new messaging.PropertyEntry(), j); }
  public messaging.PropertyEntry properties(messaging.PropertyEntry obj, int j) { int o = __offset(20); return o != 0 ? obj.__assign(__indirect(__vector(o) + j * 4), bb) : null; }
  public int propertiesLength() { int o = __offset(20); return o != 0 ? __vector_len(o) : 0; }
  public messaging.PropertyEntry propertiesByKey(String key) { int o = __offset(20); return o != 0 ? messaging.PropertyEntry.__lookup_by_key(null, __vector(o), key, bb) : null; }
  public messaging.PropertyEntry propertiesByKey(messaging.PropertyEntry obj, String key) { int o = __offset(20); return o != 0 ? messaging.PropertyEntry.__lookup_by_key(obj, __vector(o), key, bb) : null; }
  public messaging.PropertyEntry.Vector propertiesVector() { return propertiesVector(new messaging.PropertyEntry.Vector()); }
  public messaging.PropertyEntry.Vector propertiesVector(messaging.PropertyEntry.Vector obj) { int o = __offset(20); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }
  public messaging.CustomStrategyResult customStrategiesResults(int j) { return customStrategiesResults(new messaging.CustomStrategyResult(), j); }
  public messaging.CustomStrategyResult customStrategiesResults(messaging.CustomStrategyResult obj, int j) { int o = __offset(22); return o != 0 ? obj.__assign(__indirect(__vector(o) + j * 4), bb) : null; }
  public int customStrategiesResultsLength() { int o = __offset(22); return o != 0 ? __vector_len(o) : 0; }
  public messaging.CustomStrategyResult customStrategiesResultsByKey(String key) { int o = __offset(22); return o != 0 ? messaging.CustomStrategyResult.__lookup_by_key(null, __vector(o), key, bb) : null; }
  public messaging.CustomStrategyResult customStrategiesResultsByKey(messaging.CustomStrategyResult obj, String key) { int o = __offset(22); return o != 0 ? messaging.CustomStrategyResult.__lookup_by_key(obj, __vector(o), key, bb) : null; }
  public messaging.CustomStrategyResult.Vector customStrategiesResultsVector() { return customStrategiesResultsVector(new messaging.CustomStrategyResult.Vector()); }
  public messaging.CustomStrategyResult.Vector customStrategiesResultsVector(messaging.CustomStrategyResult.Vector obj) { int o = __offset(22); return o != 0 ? obj.__assign(__vector(o), 4, bb) : null; }

  public static int createContextMessage(FlatBufferBuilder builder,
  ...
  public static void addRuntimeHostname(FlatBufferBuilder builder, int runtimeHostnameOffset) { builder.addOffset(7, runtimeHostnameOffset, 0); }
  ...
  public static void addCustomStrategiesResults(FlatBufferBuilder builder, int customStrategiesResultsOffset) { builder.addOffset(9, customStrategiesResultsOffset, 0); }
  public static int createCustomStrategiesResultsVector(FlatBufferBuilder builder, int[] data) { builder.startVector(4, data.length, 4); for (int i = data.length - 1; i >= 0; i--) builder.addOffset(data[i]); return builder.endVector(); }
  ...
  public static final class Vector extends BaseVector {
    ...
    public ContextMessage get(int j) { return get(new ContextMessage(), j); }
    public ContextMessage get(ContextMessage obj, int j) {  return obj.__assign(__indirect(__element(j), bb), bb); }
  }
}
