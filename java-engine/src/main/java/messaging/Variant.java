...
public final class Variant extends Table {
  ...
  public boolean featureEnabled() { int o = __offset(6); return o != 0 ? 0!=bb.get(o + bb_pos) : false; }
  ...
  public messaging.VariantPayload payload(messaging.VariantPayload obj) { int o = __offset(10); return o != 0 ? obj.__assign(__indirect(o + bb_pos), bb) : null; }
  ...
  public static void startVariant(FlatBufferBuilder builder) { builder.startTable(4); }
  public static void addEnabled(FlatBufferBuilder builder, boolean enabled) { builder.addBoolean(0, enabled, false); }
  public static void addFeatureEnabled(FlatBufferBuilder builder, boolean featureEnabled) { builder.addBoolean(1, featureEnabled, false); }
