...
public final class Response extends Table {
  ...
  public boolean hasEnabled() { int o = __offset(8); return o != 0 ? 0!=bb.get(o + bb_pos) : false; }
  ...
  public static void addHasEnabled(FlatBufferBuilder builder, boolean hasEnabled) { builder.addBoolean(2, hasEnabled, false); }
