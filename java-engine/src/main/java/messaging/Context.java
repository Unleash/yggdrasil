...
public final class Context extends Table {
  ...
  public static Context getRootAsContext(ByteBuffer _bb) {
    return getRootAsContext(_bb, new Context());
  }

  public static Context getRootAsContext(ByteBuffer _bb, Context obj) {
  ...
  public Context __assign(int _i, ByteBuffer _bb) {
    __init(_i, _bb);
    return this;
  }
  ...
  public static void finishContextBuffer(FlatBufferBuilder builder, int offset) {
    builder.finish(offset);
  }

  public static void finishSizePrefixedContextBuffer(FlatBufferBuilder builder, int offset) {
  ...
  public static final class Vector extends BaseVector {
    ...
    public Context get(int j) {
      return get(new Context(), j);
    }

    public Context get(Context obj, int j) {
